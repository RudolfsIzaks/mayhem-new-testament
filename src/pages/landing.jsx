  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-2 justify-center items-center h-screen px-4 md:px-20 lg:px-40 hero" data-aos="fade-down">
        <div>
          <h3 className="font-montserrat text-lg md:text-2xl mb-5 md:mb-10 text-yellow font-bold italic text-center">
            ACCELERATE YOUR ONLINE BUSINESS & GET:
          </h3>
          <h1 className="text-2xl md:text-5xl font-black italic text-white text-center">
      ...
      <div id="video" className="pt-10 md:pt-20 flex w-full px-4 md:px-20 flex-col gap-5 items-center">
        ...
        <h2 className="text-white text-xl md:text-2xl font-bold font-montserrat italic md:text-center " data-aos="fade-left">
      ...
      <div className="mt-20 md:mt-40 flex flex-col gap-3 mx-4 md:mx-20 relative h-auto md:h-screen" data-aos="fade-up">
        ...
        <h1 className="font-montserrat font-black text-2xl md:text-5xl italic text-center text-white px-4 py-5 md:py-0 md:px-20">OUR UNIVERSAL ARSENAL FOR 7-FIGURE  DOMINATION</h1>
        <div className="lg:absolute bg-yellow rounded-lg px-5 py-2 p_1"><p className="font-montserrat font-bold text-lg">Viral Video Ads</p></div>
        <div className="lg:absolute bg-accent text-white rounded-sm px-4 py-3 p_2"><p className="font-montserrat font-bold text-lg">Funnel CRO</p></div>
        <div className="lg:absolute bg-yellow rounded-lg px-5 py-2 p_3"><p className="font-montserrat font-bold text-lg">Superior Websites</p></div>
        <div className="lg:absolute bg-accent text-white px-5 py-2 p_4"><p className="font-montserrat font-bold text-lg">Killer CopyWriting</p></div>
        <div className="lg:absolute bg-yellow rounded-lg px-5 py-2 p_5"><p className="font-montserrat font-bold text-lg">Strategic Marketing</p></div>
        <div className="lg:absolute bg-yellow rounded-md px-5 py-2 p_6"><p className="font-montserrat font-bold text-lg">Automated Sales Systems</p></div>
